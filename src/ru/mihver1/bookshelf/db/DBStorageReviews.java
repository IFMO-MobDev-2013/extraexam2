...
public class DBStorageReviews {
    ...
    private static final String FIELDS = "uid TEXT, rate TEXT, msg TEXT";
    private static final String SQL_CREATE = "CREATE TABLE " + TABLE_NAME + " (" + FIELDS + ")";

    private SQLiteDatabase db;

    public DBStorageReviews(Context context) {
    ...
    public ArrayList<BookItem> getReviewList() {
        ArrayList<ReviewItem> answer = new ArrayList<ReviewItem>();
